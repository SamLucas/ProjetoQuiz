...
<head>
    ...
    <!-- color CSS -->
    <link href="<?= $caminho ?>/css/colors/blue.css" id="theme" rel="stylesheet">
...
<body>
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?php echo base_url('index.php/back_home') ?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
    ...
    <script src="<?= $caminho ?>/bootstrap/dist/js/bootstrap.min.js"></script>
